  ...
  return (
    <div className={`flex h-[100vh] ml-10 md:ml-20 flex-col  bg-[#F5F7FA] items-center justify-between p-24 `}>
      ...
      <div className="mx-auto rounded-lg text-center py-16  ">
        <h2   class="text-3xl md:text-[40px] lg:text-[60px]  font-bold mb-8 text-gray-800">Crop PDF Files</h2>
        <p class="text-2xl text-gray-600 mb-8">
        Use our PDF manipulation capabilities which let you crop from your PDF.
        </p>
